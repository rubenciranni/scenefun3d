...
import os
import numpy as np
from scenefun3d.eval.affordance_grounding.eval_utils.eval_script import evaluate
from scenefun3d.eval.affordance_grounding.eval_utils.util_3d import get_excluded_point_mask
from scenefun3d.eval.affordance_grounding.eval_utils.rle import rle_decode, rle_encode
